...
Only GA in workspace in selected regions
- 3423345aws: `us-east-1` or `us-west-2`.
- Azure: `centralus`, `eastus`, `eastus2`, `northcentralus`, `southcentralus`. `westus`, or `westus2`
